...
function displayPics(){
  ...
  // The previous line of code threw an error when we changed the variable declaration from 'var' to 'let' because when we declare variables with 'let' they are confined to their code blocks. So trying to 'console.log(rando);' outside of its block will not work because that is outside of its scope.
  console.log(viewed);
