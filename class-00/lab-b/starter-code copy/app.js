...
// In the current context, "this" refers to the "Student" as defined by our Student constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
// In this context, "this" refers to everything within the browser window.
// 3. Explain why "this" is different when an arrow function is used.
// The definition of "this" changes due to the methods used because arrow functions retain the "this" value of the enclosing functional scope. If there isn't a non-arrow function scope surrounding, the "this" context will be, in the browser, the global window object. The "this" context is not reset within an arrow function. The value of "this" is therefore the same as the "this" of the enclosing scope.
